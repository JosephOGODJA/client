    ...
    <React.Fragment>
      <Grid item container direction="row" justifyContent="space-evenly" alignItems="baseline" >
        <Grid item container sx={{ width: 128, height: 128 }} alignItems="center" justifyContent="space-between" >
            <Grid items >
              <Item>
                <TeamNameAndLogo alt="USA-flag" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Flag_of_the_United_States.svg/2560px-Flag_of_the_United_States.svg.png" name="USA" />
              </Item>
            </Grid>
        </Grid>
